...
If we just want to simulate the above test bench, we can avoid going
via Verilog by using the in-Haskell simulator.
...
more convenient for small designs.  Note that it also has fewer
features (no
