...
Applications of Blarney include
https://github.com/CTSRD-CHERI/SIMTight[SIMTight] (a CHERI-enabled
RISC-V GPGPU) and https://github.com/blarney-lang/SIMTight[Actora] (a
stack machine, with a compiler for an Erlang-like language).
